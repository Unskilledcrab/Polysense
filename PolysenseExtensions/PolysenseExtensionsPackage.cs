...
namespace PolysenseExtensions
{
    ...
    [Guid(PolysenseExtensionsPackage.PackageGuidString)]
    public sealed class PolysenseExtensionsPackage : AsyncPackage
    {
        /// <summary>
        /// PolysenseExtensionsPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "64476d02-fa81-47de-aa7a-d98ee1046ecf";
